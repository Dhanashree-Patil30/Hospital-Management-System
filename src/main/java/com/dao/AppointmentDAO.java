...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appoinment ap) {
		boolean f=false;
		try {
  ...
  public List<Appoinment> getAllAppoinmentByDoctorLogin(int doctorId){
	  List<Appoinment> list=new ArrayList<Appoinment>();
	  Appoinment ap=null;
  ...
  public Appoinment getAllAppoinmentById(int id){
